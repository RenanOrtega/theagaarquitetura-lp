    ...
    >
      <div className="flex justify-center gap-12 pb-12">
        ...
        <div className="text-white">
          <h3 className="text-xl font-bold text-[var(--color-primary-lightest)]" style={{ marginBottom: '0' }}>Contato</h3>
          <div className="flex flex-col gap-4">
            <p className="flex items-center justify-center md:justify-start" style={{ gap: '0' }}>
              <span>📧</span>
              <a
        ...
        {/* Redes Sociais */}
        <div className="text-white">
          <h3 className="text-xl font-bold text-[var(--color-primary-lightest)]" style={{ marginBottom: '0' }}>
            Redes Sociais
          </h3>
          <div className="flex justify-center gap-8">
            ...
            >
              <svg
                className="w-5 h-5 fill-[var(--color-primary-dark)] opacity-40"
                viewBox="0 0 24 24"
              >
